		...
		return(
			<div className="panel panel-default panel-margins">
				...
				<div className="panel-body">
					  					...
					  					return(
					  						(idx == this.state.editingColumn ? 
					  							<th className="textAlignCenter" key={"col-"+idx}>
					  								<input defaultValue={column.label} ref={"edit-field-"+idx} maxLength={255}/>
					  								<span>&nbsp;</span>
					...
					<span className="mdi mdi-check btn btn-sm btn-success" onClick={this.save} disabled={this.props.saveButtonClicked} title={Messages.get("label.submitLabel")} />
		            	<span>&nbsp;</span>
