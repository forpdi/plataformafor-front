...
import FormattedText from "forpdi/src/forpdi/vendor/FormattedText";
...
export default React.createClass({
	...
	getValue() {
		...
		if (this.props.fieldDef.type === 'message') {
	...
	render() {
		...
		if (this.props.fieldDef.type == 'checkbox') {
			fieldEl = (<div className="checkbox checkbox-company">
				...
				<label htmlFor={this.state.fieldId} className="fpdi-text-label">
					...
					{this.props.fieldDef.required && !this.props.fieldDef.fieldLabel && <span className="fpdi-required">&nbsp;</span>}
				</label>
		...
		} else if (this.props.fieldDef.type == 'password') {
			fieldEl = (
			<div style={{position: 'relative'}}>
				<input
					className={"form-control "+ this.props.className}
					type={this.props.fieldDef.visible ? 'text' : this.props.fieldDef.type}
					name={this.props.fieldDef.name}
					maxLength={this.props.fieldDef.maxLength}
					defaultValue={this.props.fieldDef.value}
					value={this.props.fieldDef.currValue}
				...
				/>
				{this.props.onChangeVisibility && <span
					className={`mdi mdi-eye fpdi-toggle-password`}
		...
		const fieldLabel = this.props.fieldDef.type !== 'checkbox'
			? this.props.fieldDef.label
			: this.props.fieldDef.fieldLabel;
