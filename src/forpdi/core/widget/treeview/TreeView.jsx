...
import TreeViewNode from "forpdi/src/forpdi/core/widget/treeview/TreeViewNode.jsx";
...
export default React.createClass({
	...
	render() {
		return <div className="fpdi-treeview" style={{ maxHeight: '500px', overflow: 'auto' }}>
